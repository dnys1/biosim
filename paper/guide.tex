...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{guide_start}
    \caption{Start Page}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.75\textwidth]{guide_buttons}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.75\textwidth]{guide_temp}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.75\textwidth]{guide_crop}
    \caption{Crop Page}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.75\textwidth]{guide_water}
    \caption{Water Page}
    \label{fig:guide_water}
\end{figure}
\begin{figure}[p]
    \centering
    \includegraphics[width=0.75\textwidth]{guide_flow}
    \caption{Flows Page}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.75\textwidth]{guide_energy}
    \caption{Energy Page}
